...
df_1 = df_1.loc[(df_1['new_participant_complete'] == '2')
                & (df_1['consent'] == '1')
                & (df_1['consent_complete'] == '2')].set_index('study_id')
...
df = df_2.merge(df_1, how='inner', on='study_id')
...
melt_df.to_csv(sys.argv[1], index=False)
